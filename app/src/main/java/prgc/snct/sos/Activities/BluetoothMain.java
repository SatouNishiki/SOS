...
//import prgc.snct.sos.Share.BluetoothChatService.R;
import prgc.snct.sos.Share.BluetoothChatService;
...
/*
    ...
    private TextView readText,writeText;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_WRITE:
                    ...
                    writeText.setText(writeMessage);
                    break;
                case MESSAGE_READ:
                    byte[] readBuf = (byte[]) msg.obj;
                    // construct a string from the valid bytes in the buffer
                    String readMessage = new String(readBuf, 0, msg.arg1);
                    readText.setText(readMessage);
                    break;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_bluetooth_main, menu);
        return true;
    }
